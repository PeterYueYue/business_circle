    ...
    <div class="sq_main">
        ...
        <div class="membercard_set">
            ...
            <el-form ref="form" :model="form" label-width="128px" :rules="rules_1">
                ...
                <el-form-item label="栏位设置 :"  >
                    ...
                    <div style="margin-bottom: 10px;">
                        ...
                        <el-input style="display:inline-block;width: 140px;margin-right:20px;" :readonly = 'readonly' size="small"  value="优惠信息"></el-input>
                    ...
                    <div style="margin-bottom: 10px;">
                        ...
                        <el-input style="display:inline-block;width: 140px;margin-right:20px;" :readonly = 'readonly' size="small"  value="积分兑券"></el-input>
                    ...
                    <div style="margin-bottom: 10px;">
                        ...
                        <el-input style="display:inline-block;width: 140px;margin-right:20px;" :readonly = 'readonly' size="small"  value="积分转盘"></el-input>
                    ...
                    <div style="margin-bottom: 10px;" v-for="(item,index) in lwlist">
                        <div>
                            <span>({{index+5}}) </span><span><i style="color:#ff4949;">* </i>标题 : </span><el-input style="display:inline-block;width: 140px"  size="small" v-model="item.title"  placeholder="请填写标题"></el-input>&#X3000;
                ...
                <el-form-item>
                    <el-button v-if=form.id class="bottom_button" :disabled="disabled" size="small" type="primary" @click="set_Membercard('form')">修 改
                    </el-button>
                    <el-button v-if=!form.id class="bottom_button" :disabled="disabled" size="small" type="primary" @click="set_Membercard('form')">提 交
                    </el-button>
                </el-form-item>
            </el-form>
            ...
            <el-form  label-width="128px">
                ...
                <el-form-item>
                    <el-button class="bottom_button " :disabled="checksuredisabled" size="small" type="primary" @click="checksure">确 定</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
    ...
    export default {
        ...
        methods: {
            ...
            up_Membercard() {
                ...
                console.log(this.form.selfPoint)
